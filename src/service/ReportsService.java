...
public class ReportsService {
    ...
    public void run(final Connection connection) {
        ...
        try {
            ...
            while (true) {
                System.out.println("\n\nREPORTS:");
                System.out.println("1. Get Purchase Summary per Distributor");
    ...
    /* Method to generate montly reports: number and total price of copies of each publication bought per distributor per month */
    ...
    /* Method to retrieve the total payments to the authors per time period */
